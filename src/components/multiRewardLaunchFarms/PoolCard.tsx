...
export default function PoolMultiRewardCard({ stakingInfo, isInactive }: { stakingInfo: StakingInfo, isInactive: boolean }) {
  ...
  return (
    <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
      ...
      <TopSection>
        ...
        <StyledInternalLink to={`/multi-reward-launch-farms/${isInactive ? 'archived/' : ''}${currencyId(currency0, chainId)}/${currencyId(currency1, chainId)}/${stakingInfo.version}`} style={{ width: '100%' }}>
