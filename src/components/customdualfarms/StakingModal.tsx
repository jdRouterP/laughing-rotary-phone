...
import { useBYOFDualFarmsContract, usePairContract } from '../../hooks/useContract'
...
import { StakingInfo, useDerivedStakeInfo } from 'state/custom-dual-farm-stake/hooks'
...
export default function StakingModal({ isOpen, onDismiss, stakingInfo, userLiquidityUnstaked }: StakingModalProps) {
  ...
  (typedValue, stakingInfo.stakedAmount.token, userLiquidityUnstaked)
