import { JSBI, Pair, Percent, TokenAmount } from '@dfyn/sdk'
      ...
      <AutoColumn gap="12px">
        ...
        {showMore && (
          <AutoColumn gap="8px">
            ...
            {userDefaultPoolBalance && JSBI.lessThanOrEqual(userDefaultPoolBalance.raw, BIG_INT_ZERO) && (
              <RowBetween marginTop="10px">
                <ButtonPrimary
                  padding="8px"
                  borderRadius="8px"
            ...
            {stakedBalance && JSBI.greaterThan(stakedBalance.raw, BIG_INT_ZERO) && (<>
              <ButtonPrimary
                ...
                borderRadius="8px"
                as={Link}
                to={`/${stakingInfo ? stakingInfo.type.url : "flora-farms"}/${currencyId(currency0, chainId)}/${currencyId(currency1, chainId)}/${stakingInfo.version}`}
                width="100%"
              >
