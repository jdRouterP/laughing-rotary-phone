...
import { MultiStakingInfo, useDerivedStakeInfo } from '../../state/multiTokenVault/hooks'
...
export default function StakingModal({ isOpen, onDismiss, stakingInfo, userLiquidityUnstaked }: StakingModalProps) {
  ...
  //   // if (!vaultContract || !library || !deadline) throw new Error('missing dependencies')
  ...
  //   // const nonce = await vaultContract.nonces(account)
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOnDismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            <TYPE.largeHeader>Depositing ROUTE Tokens</TYPE.largeHeader>
            <TYPE.body fontSize={20}>{parsedAmount?.toSignificant(4)} ROUTE</TYPE.body>
          </AutoColumn>
        </LoadingView>
      )}
      {attempting && hash && (
        <SubmittedView onDismiss={wrappedOnDismiss} hash={hash}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>Deposited {parsedAmount?.toSignificant(4)} ROUTE</TYPE.body>
          </AutoColumn>
        </SubmittedView>
      )}
    </Modal>
