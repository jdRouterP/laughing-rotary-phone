    ...
    <Tabs>
      <RowBetween style={{ padding: "1rem 1rem 0 1rem" }}>
        ...
        <TopSection>
          ...
          <Icon>
            {chainId && HEADER_ACCESS.gaslessMode.includes(chainId) && (
              <GaslessModeElement>
                <MouseoverTooltip
                  text={
                    "Gasless Mode. This button will toggle Dfyn’s gasless feature for your wallet. Users with hardware wallets should keep this setting turned off."
                  }
                  placement="bottom"
                >
                  <LocalGasStation
                    style={{ color: toggleValue ? "#2ecc71" : "" }}
                  />
                </MouseoverTooltip>
                {/* <CustomToggle> */}
                <Toggle
