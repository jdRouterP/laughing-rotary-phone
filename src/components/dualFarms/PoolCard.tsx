...
import { StakingInfo } from '../../state/dual-stake/hooks'
  ...
  return (
    <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
      ...
      <TopSection>
        ...
        <StyledInternalLink to={`/dual-farms/${isInactive ? 'archived/' : ''}${currencyId(currency0, chainId)}/${currencyId(currency1, chainId)}/${stakingInfo.version}`} style={{ width: '100%' }}>
