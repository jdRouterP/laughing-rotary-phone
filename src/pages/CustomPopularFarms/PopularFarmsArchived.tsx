...
export default function PopularFarmsArchived() {
  ...
  const stakingInfos = useInactiveStakingCustomFloraFarmInfo();
  /**
  ...
  const stakingRewardsExist = Boolean(typeof chainId === 'number' && (inactiveFloraFarms.length ?? 0) > 0)
            ...
            <CardSection>
              <AutoColumn gap="md">
                <TopSectionHeader>
                  ...
                  <StyledInternalLink to={`/custom-popular-farms`} style={{ width: '100%', color: '#ff007a' }}>
