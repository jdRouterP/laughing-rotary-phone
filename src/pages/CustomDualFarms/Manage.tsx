...
import StakingModal from '../../components/customdualfarms/StakingModal'
import UnstakingModal from '../../components/customdualfarms/UnstakingModal'
import ClaimRewardModal from '../../components/customdualfarms/ClaimRewardModal'
...
export default function Manage({
  ...
  const dualContract = useBYOFDualFarmsContract(stakingAddress)
  ...
  const stakingInfo = useStakingDualFarmInfo(stakingAddress)?.[0]
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          When you withdraw, the contract will automatically claim rewards on your behalf!
        </TYPE.main>
