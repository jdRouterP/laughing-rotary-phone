...
import { useMultiStakingInfo } from '../../state/multiRewardLaunchFarm/hooks'
...
export default function Manage({
  ...
  const stakingInfo = useMultiStakingInfo(stakingTokenPair)?.[0]
  ...
  // const totalEarnedRewardTwo = stakingInfo?.totalEarnedRewardTwo?.toFixed(2) ?? '0';
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          {`You can claim 20% of your ${stakingInfo ? reward0?.symbol : ""} && ${stakingInfo ? reward1?.symbol : ""}  token rewards after the farming program ends, and the remaining will be released 20% every other month!`}
        </TYPE.main>
