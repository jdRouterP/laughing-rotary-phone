...
import StakingModal from '../../components/customVanillaFarms/StakingModal'
import { useInactiveCustomVanillaStakingInfo } from '../../state/custom-vanilla-stake/hooks'
import UnstakingModal from '../../components/customVanillaFarms/UnstakingModal'
import ClaimRewardModal from '../../components/customVanillaFarms/ClaimRewardModal'
...
export default function Manage({
  ...
  const ecoContract = useBYOFDualFarmsContract(stakingAddress)
  const lpAddress = useSingleCallResult(ecoContract, 'stakingToken')
  ...
  const stakingInfo = useInactiveCustomVanillaStakingInfo(stakingAddress)?.[0]
