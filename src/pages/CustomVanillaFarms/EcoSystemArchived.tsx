...
export default function EcoSystemArchived() {
  ...
  const stakingInfos = useInactiveCustomVanillaStakingInfo();
  ...
  const stakingRewardsExist = Boolean(typeof chainId === 'number' && (inactiveEcoSystemFarms?.length ?? 0) > 0)
            ...
            <CardSection>
              <AutoColumn gap="md">
                <TopSectionHeader>
                  ...
                  <StyledInternalLink to={`/custom-eco-farms`} style={{ width: '100%', color: '#ff007a' }}>
