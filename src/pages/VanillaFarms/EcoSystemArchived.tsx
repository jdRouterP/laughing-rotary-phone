...
export default function EcoSystemArchived() {
  ...
  const stakingCustomVanillaInfos = useInactiveCustomVanillaStakingInfo()
  /**
  ...
  //for custom inactive vanilla farms
  ...
  const stakingCustomVanillaRewardsExist = Boolean(typeof chainId === 'number' && (inactiveEcoSystemFarms?.length ?? 0) > 0)
              ...
              }
              {
                stakingCustomVanillaFarms?.filter(stakingInfos => {
                  ...
                  //Other case
                    ...
                    // need to sort by added liquidity here
                    return <PoolCardCustomVanilla key={stakingInfo.stakingRewardAddress} stakingInfo={stakingInfo} isInactive={true} />
                })
              }
            </>
