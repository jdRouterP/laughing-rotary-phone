...
import StakingModal from '../../components/dualFarms/StakingModal'
import { useInactiveStakingInfo } from '../../state/dual-stake/hooks'
import UnstakingModal from '../../components/dualFarms/UnstakingModal'
import ClaimRewardModal from '../../components/dualFarms/ClaimRewardModal'
...
export default function Manage({
  ...
  const stakingInfo = useInactiveStakingInfo(stakingTokenPair, version)?.[0]
